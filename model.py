...
categorical_cols_r = X_reduced.select_dtypes(include=["object", "str"]).columns.tolist()
...
cat_features_r = (
    rf_model_reduced.named_steps["preprocess"]
    .named_transformers_["category"]
    .get_feature_names_out(categorical_cols_r)
)


all_features_r = numeric_cols_r + list(cat_features_r)
importances_r  = rf_model_reduced.named_steps["model"].feature_importances_


feature_importance_dict = dict(zip(all_features_r, importances_r))


# Print so you can verify the keys look correct
